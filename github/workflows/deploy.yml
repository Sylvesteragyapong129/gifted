...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~K2IgiLwa#l5W_ze5bHQ0n9liieAi9rzX5Uptf9NxCWbIqi68xutc", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "233595652412", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "BIG SLY", // Input Yours custom...(Maintain font for Flow)
